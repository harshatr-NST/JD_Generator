...
# Register Arial font (replace with the actual path to Arial.ttf)
try:
    pdfmetrics.registerFont(TTFont('Arial', 'Arial.ttf'))
except:
    print("Arial font not found. Using Helvetica instead.")
...
def generate_template_pdf(
    ...
    if left_style is None:
        left_style = ParagraphStyle(
            name="LeftCol",
            fontName="Helvetica",  # Fallback to Helvetica
            fontSize=8,
    ...
    for label in fields:
        ...
        if isinstance(value, str) and "\n" in value:
            ...
            table_data.append([Paragraph(str(label), left_style), paragraphs])
        else:
            table_data.append([Paragraph(str(label), left_style), Paragraph(str(value), right_style)])
    ...
    if table_style is None:
        table_style = TableStyle([
            ...
            ("FONTNAME", (0, 0), (0, -1), "Helvetica"),  # Fallback to Helvetica
            ("FONTSIZE", (0, 0), (0, -1), 8),
            ("BACKGROUND", (1, 0), (1, -1), colors.white),
            ("TEXTCOLOR", (1, 0), (1, -1), colors.black),
            ("FONTNAME", (1, 0), (1, -1), "Helvetica"),  # Fallback to Helvetica
            ("FONTSIZE", (1, 0), (1, -1), 8),
        ])
